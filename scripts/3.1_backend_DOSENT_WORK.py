...
def home():
    ...
    return render_template("3.1_good_design_index.html")
  # return render_template("3.1_good_design_index.html", inputMessagesArray=session['inputMessageList'],outputMessagesArray=session['outputMessageList'])
